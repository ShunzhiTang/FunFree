//
//  UINavigationController+FFScreenPopGesture.m
//  FunFree
//
...
@interface _FFScreenPopGestureRecognizerDelegate : NSObject <UIGestureRecognizerDelegate>
...
@interface UIViewController (FFScreenPopGesturePrivate)
