...
- (void)layoutSubviews {
    ...
    [self.tabBarButtonArray
        enumerateObjectsUsingBlock:^(UIView *_Nonnull childView, NSUInteger buttonIndex, BOOL *_Nonnull stop) {
            ...
            //仅修改childView的x和宽度
            childView.frame = CGRectMake(childViewX, CGRectGetMinY(childView.frame), FFTabBarItemWidth,
...
- (NSArray *)sortedSubviews {
    ...
    NSArray *sortedSubviews =
        [self.subviews sortedArrayUsingComparator:^NSComparisonResult(UIView *formerView, UIView *latterView) {
