...
- (FFTabBarController *)tabBarController{
    ...
    if (_tabBarController == nil) {
        ...
        FFTabBarController *tabBarController = [FFTabBarController tabBarControllerWithViewControllers:self.viewControllers tabBarItemsAttributes:self.tabBarItemsAttributesForController];
